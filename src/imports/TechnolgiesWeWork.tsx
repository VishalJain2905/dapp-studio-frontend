  ...
  return (
    <div className="absolute bg-white h-[124px] left-0 top-1/2 translate-y-[-50%] w-[835px]">
      <div className="leading-[normal] not-italic overflow-clip relative rounded-[inherit] size-full text-nowrap">
        <p className="absolute font-['Neue_Haas_Grotesk_Display_Pro:55_Roman',sans-serif] left-[40px] text-[26px] text-black top-[calc(50%-15px)]">{`Technology name `}</p>
...
function Frame() {
  return (
    <div className="absolute h-[72px] left-[80px] top-[160px] w-[590px]">
      ...
      <Component2 />
      <Component3 />
      <p className="absolute font-['Neue_Haas_Grotesk_Display_Pro:55_Roman',sans-serif] leading-[normal] left-0 not-italic text-[60px] text-black text-nowrap top-0">Technology Capablities</p>
    </div>
  );
}
