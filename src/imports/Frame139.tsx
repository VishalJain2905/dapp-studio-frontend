import svgPaths from "./svg-4jvngkcmwk";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[9px] items-start relative shrink-0 w-full">
      <IcRoundDone />
      <p className="font-body leading-[normal] not-italic relative shrink-0 text-[#909090] text-[14px] w-[264px]">Clean, modern frontend with responsive design </p>
    </div>
  );
}
...
export default function Frame4() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] overflow-clip relative rounded-[24px] size-full">
      <p className="absolute font-display leading-[normal] left-[calc(50%-30px)] not-italic text-[20px] text-white top-[60px] w-[61px]">Starter</p>
